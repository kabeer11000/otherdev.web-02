...
export const knowledgeBase: KnowledgeDocument[] = [
  ...
  },
  {
    ...
    metadata: {
      ...
      subtype: 'facts',
      project: 'kiswanoire-2025',
      year: '2025',
    },
  },
  {
    content:
      'Kiswa Noire is a contemporary fashion label with a distinct avant-garde aesthetic rooted in refined craftsmanship and dark elegance. The challenge was translating that identity into an interactive digital experience while preserving clarity, premium positioning, and usability. Key requirements included multilingual support across EN, DE, FR, DK markets, geolocation-based personalization, and a seamless experience across devices and touchpoints.',
    metadata: {
      source: 'projects',
  ...
  {
    content:
      "Design approach: Crafted a minimal interactive visual system aligned with the brand's contemporary and avant-garde direction. Visual storytelling: Product imagery and layout were optimized to emphasize craftsmanship and premium presentation. Navigation system: Built a mega menu with visual category blocks for fast product discovery. Technical implementation: Custom Shopify theme with CSS variables for consistent responsive behavior. Multilingual setup: Implemented EN, DE, FR, DK language support with geolocation personalization. Payment integration: Added Apple Pay, Google Pay, PayPal for market preferences. Performance optimization: Lazy-loaded assets, custom JavaScript interactions, performance tracking. Compliance: Deployed GDPR-compliant systems for European data protection. Inventory management: Configured multi-market inventory synchronization.",
    metadata: {
      source: 'projects',
...
URL: https://wishapparels.com/`,
  ...
  {
    content:
      'Results. Post launch metrics showed improved engagement and sustained increase in sales performance. The brand identity increased recognition across channels and the optimized checkout reduced abandonment. The platform now supports future expansion in product lines and markets.',
    metadata: {
      source: 'projects',
      title: 'Wish Results',
      type: 'project',
...
URL: https://parcheh81.com/`,
  ...
  {
    content:
      'Tech Stack. Shopify was used for commerce with a custom front end to support high fidelity imagery and zoom. Image optimization and lazy loading balanced visual quality with performance. Theme components provided reusable product presentation patterns for consistent UX.',
    metadata: {
      source: 'projects',
  ...
  {
    content:
      'Implementation. We designed gallery style product pages with zoom and progressive image loading. The UI emphasized curated storytelling sections and clear purchase flows. Checkout and inventory management were implemented to support seasonal drops and high resolution assets without performance regression.',
    metadata: {
      source: 'projects',
  ...
  {
    content:
      'Results. The site improved conversion and average order value through better product presentation and narrative. Brand perception strengthened and sales increased after launch. The platform is now used as the primary sales channel and brand showcase.',
    metadata: {
      source: 'projects',
  ...
  {
    content:
      'Working with Other Dev transformed Parcheh. Their combined web and branding expertise delivered results beyond expectations. The user friendly site achieved a dramatic boost in sales. The sophisticated branding reflects our identity perfectly and is now used everywhere. We highly recommend Other Dev to any brand needing impactful digital results. - Nasir, Founder of Parcheh',
    metadata: {
      source: 'testimonials',
...
URL: https://www.tinyfootprintcoffee.com/`,
  ...
  {
    content:
      'Tech Stack. Shopify Payments replaced Recharge. Migration scripts handled mapping of subscriber records and payment tokens while preserving billing cycles. Data validation and test migrations were used to confirm integrity. The stack prioritized security and auditable transfers.',
    metadata: {
      source: 'projects',
  ...
  {
    content:
      'Results. The migration completed with zero subscriber disruption. Subscription management is now native to Shopify which simplified operations and reduced maintenance overhead. The client regained time to focus on mission activities and subscriber engagement.',
    metadata: {
      source: 'projects',
...
URL: http://ekqadamaur.kabeers.network/`,
  ...
  {
    content:
      'Tech Stack. The solution used a CMS back end integrated with static or server rendered front ends depending on use case. Hosting was configured for high availability with backups and standard security controls. API endpoints supported integrations with project management tools.',
    metadata: {
      source: 'projects',
  ...
  {
    content:
      'Implementation. We delivered a modular infrastructure with content workflows, role based access controls and automated backups. Performance optimizations and caching ensured responsive pages across devices. Integrations were built to allow program updates and document sharing between stakeholders.',
    metadata: {
      source: 'projects',
  ...
  {
    content:
      'Results. The platform provided a robust public presence and internal content management for program teams. System reliability improved communications with stakeholders and supported program scaling without infrastructure bottlenecks.',
    metadata: {
      source: 'projects',
  ...
  {
    content:
      'Enterprise infrastructure development for Ek Qadam Aur. Visit: http://ekqadamaur.kabeers.network/',
    metadata: {
      source: 'testimonials',
...
URL: https://groovypakistan.com/`,
    metadata: {
      ...
      subtype: 'facts',
      project: 'groovy-pakistan-2024',
      year: '2024',
    },
  },
  {
    content:
      'Overview. Groovy Pakistan required a cohesive e commerce experience that matches their brand energy and handles diverse products. The challenge included building a cohesive catalog, search and filtering, and reliable payment flows. This was critical to scale online sales and reach their target customers.',
    metadata: {
      source: 'projects',
  ...
  {
    content:
      'Tech Stack. Shopify provided the commerce core. A custom storefront enabled advanced filtering and search to handle product complexity. Multiple payment gateways and account features supported conversions and repeat purchases. Performance and scale considerations guided asset strategies.',
    metadata: {
      source: 'projects',
  ...
  {
    content:
      'Implementation. We built an intuitive product discovery flow with robust search, filters and category navigation. Product pages used rich media and clear specifications to reduce purchase friction. Checkout was simplified and payment integrations were tested for reliability.',
    metadata: {
      source: 'projects',
  ...
  {
    content:
      'Results. The website improved customer journeys and created a dependable online sales channel for the brand. The client gained a scalable storefront and better operational workflows for order and inventory management.',
    metadata: {
      source: 'projects',
  ...
  {
    content:
      'Working with Groovy Pakistan on their e commerce development was a rewarding experience for our team at Other Dev. We focused on understanding their brand ethos and translating that into a functional and visually engaging online platform. - Kabeer, Founder of Other Dev',
    metadata: {
      source: 'projects',
      title: 'Groovy Team Note',
      type: 'project',
      category: 'retail-ecommerce',
      subtype: 'overview',
      project: 'groovy-pakistan-2024',
...
URL: https://finlit.deployments.otherdev.com/`,
  ...
  {
    content:
      'Tech Stack. The platform used Astro and Next.js for front end performance. Vercel hosted the application for scalable deployments. Interactive modules, quizzes and progress tracking were implemented to create a course flow. The tech stack prioritized fast load times and low operational overhead.',
    metadata: {
      source: 'projects',
  ...
  {
    content:
      'Implementation. We built a minimal and focused UI to reduce cognitive load. Courses were structured into progressive lessons with interactive checks and analytics for completion. The architecture supports future course expansion and localization while keeping performance optimized.',
    metadata: {
      source: 'projects',
  ...
  {
    content:
      'Results. Finlit launched as a scalable SaaS with clear progress tracking and an accessible curriculum. The platform is positioned to onboard learners with measurable outcomes and to scale course offerings across markets.',
    metadata: {
      source: 'projects',
  ...
  {
    content:
      'Developing Finlit from the ground up was an exciting and rewarding project for our team at Other Dev. We embraced the challenge of creating a comprehensive SaaS platform that simplifies financial literacy through thoughtful branding and intuitive design. - Kabeer, Founder of Other Dev',
    metadata: {
      source: 'projects',
      title: 'Finlit Team Note',
      type: 'project',
      category: 'edtech-saas',
      subtype: 'overview',
      project: 'finlit-2025',
  ...
  // Narkins Builders (Infrastructure) - 2024
  {
    content: `PROJECT: Narkins Builders (Infrastructure)
YEAR: 2024
SERVICE: Website infrastructure creation
INDUSTRY: Real Estate
URL: https://narkinsbuilders.com
SOURCE OF TRUTH: web/src/lib/projects.ts (slug: narkins-2024)`,
    metadata: {
      source: 'projects',
      title: 'Narkins Infrastructure - Facts',
      type: 'project',
      category: 'real-estate',
      subtype: 'facts',
      project: 'narkins-2024',
      year: '2024',
    },
  },
  {
    content:
      'Overview. The 2024 Narkins Builders engagement focused on creating website infrastructure to present the construction portfolio and services with reliable UX and inquiry pathways. This project is distinct from the later 2025 SEO implementation effort.',
    metadata: {
      source: 'projects',
      title: 'Narkins Infrastructure - Overview',
      type: 'project',
      category: 'real-estate',
      subtype: 'overview',
      project: 'narkins-2024',
  ...
  {
    content:
      'Results. Delivered a stable web foundation for client communication and portfolio presentation. This infrastructure engagement established the baseline for subsequent optimization work.',
    metadata: {
      source: 'projects',
      title: 'Narkins Infrastructure - Results',
      type: 'project',
      category: 'real-estate',
      subtype: 'results',
      project: 'narkins-2024',
  ...
  // Olly Shinder - 2025
  {
    content: `PROJECT: Olly Shinder
YEAR: 2025
SERVICE: E-commerce platform development
INDUSTRY: Fashion
URL: https://olly-shinder.com
SOURCE OF TRUTH: web/src/lib/projects.ts (slug: olly-shinder-2025)`,
    metadata: {
      source: 'projects',
      title: 'Olly Shinder - Facts',
      type: 'project',
      category: 'fashion-ecommerce',
      subtype: 'facts',
      project: 'olly-shinder-2025',
      year: '2025',
    },
  },
  {
    content:
      'Overview. Olly Shinder is a menswear designer from London associated with Fashion East and Dover Street Market incubators. The project focused on a minimal grid-based platform to unify collections and commerce content in one coherent experience.',
    metadata: {
      source: 'projects',
      title: 'Olly Shinder - Overview',
      type: 'project',
      category: 'fashion-ecommerce',
      subtype: 'overview',
      project: 'olly-shinder-2025',
  ...
  {
    content:
      'Results. Delivered a unified digital presence that supports both editorial collection storytelling and e-commerce navigation with a minimal design system.',
    metadata: {
      source: 'projects',
      title: 'Olly Shinder - Results',
      type: 'project',
      category: 'fashion-ecommerce',
      subtype: 'results',
      project: 'olly-shinder-2025',
  ...
  // Cultured Legacy - 2024
  {
    content: `PROJECT: Cultured Legacy
YEAR: 2024
SERVICE: Website development
INDUSTRY: E-commerce
URL: https://culturedlegacy.shop
SOURCE OF TRUTH: web/src/lib/projects.ts (slug: cultured-legacy-2024)`,
    metadata: {
      source: 'projects',
      title: 'Cultured Legacy - Facts',
      type: 'project',
      category: 'retail-ecommerce',
      subtype: 'facts',
      project: 'cultured-legacy-2024',
      year: '2024',
    },
  },
  {
    content:
      'Overview. The Cultured Legacy project delivered a sophisticated and accessible e-commerce experience designed to reflect refined brand heritage while guiding customers through product exploration and purchase decisions.',
    metadata: {
      source: 'projects',
      title: 'Cultured Legacy - Overview',
      type: 'project',
      category: 'retail-ecommerce',
      subtype: 'overview',
      project: 'cultured-legacy-2024',
  ...
  {
    content: `Results. Delivered a polished storefront that aligns brand presentation with clear commerce journeys, improving the brand's digital foundation for ongoing growth.`,
    metadata: {
      source: 'projects',
      title: 'Cultured Legacy - Results',
      type: 'project',
      category: 'retail-ecommerce',
      subtype: 'results',
      project: 'cultured-legacy-2024',
  ...
  // NTL Exchange - 2024
  {
    content: `PROJECT: NTL Exchange
YEAR: 2024
SERVICE: Enterprise infrastructure development
INDUSTRY: Exchange services
URL: https://www.ntlex.com
SOURCE OF TRUTH: web/src/lib/projects.ts (slug: ntl-2024)`,
    metadata: {
      source: 'projects',
      title: 'NTL Exchange - Facts',
      type: 'project',
      category: 'enterprise',
      subtype: 'facts',
      project: 'ntl-2024',
  ...
  {
    content:
      'Overview. NTL Exchange required an integrated digital ecosystem including brand identity, mobile app development, responsive web presence, and enterprise-grade infrastructure to support secure and efficient exchange workflows.',
    metadata: {
      source: 'projects',
      title: 'NTL Exchange - Overview',
      type: 'project',
      category: 'enterprise',
      subtype: 'overview',
      project: 'ntl-2024',
  ...
  {
    content:
      'Results. Delivered a unified cross-platform foundation connecting branding, web, mobile, and infrastructure layers for consistent service delivery and operational reliability.',
    metadata: {
      source: 'projects',
      title: 'NTL Exchange - Results',
      type: 'project',
      category: 'enterprise',
      subtype: 'results',
      project: 'ntl-2024',
  ...
  // Boulevard Pakistan - 2025
  {
    content: `PROJECT: Boulevard Pakistan
YEAR: 2025
SERVICE: Branding and website development
INDUSTRY: Fashion
URL: https://www.blvdretail.co
SOURCE OF TRUTH: web/src/lib/projects.ts (slug: blvd-pakistan-2025)`,
    metadata: {
      source: 'projects',
      title: 'Boulevard Pakistan - Facts',
      type: 'project',
      category: 'fashion-ecommerce',
      subtype: 'facts',
      project: 'blvd-pakistan-2025',
      year: '2025',
    },
  },
  {
    content: `Overview. Boulevard Pakistan is a contemporary menswear brand rooted in local culture with global design sensibility. Other Dev's role includes shaping digital identity and supporting ongoing art direction, marketing strategy, and brand consultation.`,
    metadata: {
      source: 'projects',
      title: 'Boulevard Pakistan - Overview',
      type: 'project',
      category: 'fashion-ecommerce',
      subtype: 'overview',
      project: 'blvd-pakistan-2025',
  ...
  {
    content:
      'Results. Delivered a modern digital brand foundation and e-commerce presentation supporting both direct presence and partner-facing brand credibility.',
    metadata: {
      source: 'projects',
      title: 'Boulevard Pakistan - Results',
      type: 'project',
      category: 'fashion-ecommerce',
      subtype: 'results',
      project: 'blvd-pakistan-2025',
  ...
  // Ads Portfolio - 2026
  {
    content: `PROJECT: Ads Portfolio & Creative Design
YEAR: 2026
SERVICE: Creative advertising portfolio
INDUSTRY: Marketing and brand creative
DOWNLOAD: /images/projects/ads-portfolio/OD Ads Digital Issue.pdf
SOURCE OF TRUTH: web/src/lib/projects.ts (slug: ads-portfolio)`,
    metadata: {
      source: 'projects',
      title: 'Ads Portfolio - Facts',
      type: 'project',
      category: 'digital-marketing',
      subtype: 'facts',
      project: 'ads-portfolio',
      year: '2026',
    },
  },
  {
    content:
      'Overview. This portfolio aggregates high-impact digital ad creatives built for conversion and brand awareness across multiple campaign contexts and visual styles.',
    metadata: {
      source: 'projects',
      title: 'Ads Portfolio - Overview',
      type: 'project',
      category: 'digital-marketing',
      subtype: 'overview',
      project: 'ads-portfolio',
  ...
  {
    content:
      'Results. Provides reusable creative references and proof of execution quality for social and performance marketing campaigns.',
    metadata: {
      source: 'projects',
      title: 'Ads Portfolio - Results',
      type: 'project',
      category: 'digital-marketing',
      subtype: 'results',
      project: 'ads-portfolio',
  ...
  // Adina Household - 2026
  {
    content: `PROJECT: Adina Household
YEAR: 2026
SERVICE: E-commerce platform development
INDUSTRY: Home and tableware
URL: https://adinahousehold.com
SOURCE OF TRUTH: web/src/lib/projects.ts (slug: adinahousehold)`,
    metadata: {
      source: 'projects',
      title: 'Adina Household - Facts',
      type: 'project',
      category: 'retail-ecommerce',
      subtype: 'facts',
      project: 'adinahousehold',
      year: '2026',
    },
  },
  {
    content:
      'Overview. Adina Household required an elegant storefront for premium ceramic tableware and dinnerware collections, with presentation quality aligned to craftsmanship and material detail.',
    metadata: {
      source: 'projects',
      title: 'Adina Household - Overview',
      type: 'project',
      category: 'retail-ecommerce',
      subtype: 'overview',
      project: 'adinahousehold',
  ...
  {
    content:
      'Results. Delivered a premium visual-commerce experience that supports product storytelling and category browsing for household ceramic collections.',
    metadata: {
      source: 'projects',
      title: 'Adina Household - Results',
      type: 'project',
      category: 'retail-ecommerce',
      subtype: 'results',
      project: 'adinahousehold',
...
AVERAGE COST PER PURCHASE: Rs 211.30`,
  ...
  {
    content:
      'Other Dev is a Karachi-based software and design studio producing digital platforms for pioneering creatives. Founded in 2021 by Kabeer Jaffri and Ossaid Qadri, the agency operates at the intersection of high-performance engineering and data-driven growth. Specializations: full-stack web development, AI-powered applications, and strategic digital marketing across fashion, real estate, legal tech, SaaS, and e-commerce sectors. Philosophy: zero unnecessary fluff — no drag-and-drop builders, WordPress plugins, or shortcuts. Every project ships scalable, full-stack systems built on clean code, prioritizing measurable outcomes, technical excellence, and long-term maintainability over quick fixes. Web development expertise: AI-powered legal assistants with real-time document analysis, multi-tenant CMS platforms for scalable content management, real estate systems with Google Sheets and WhatsApp integration, and complex e-commerce platforms with advanced Shopify customization. Digital marketing capabilities: Facebook and Meta advertising with proven ROI, advanced pixel implementation for conversion tracking, data-driven optimization using A/B testing and dynamic budgeting. Website: https://www.otherdev.com',
    metadata: {
      source: 'about',
      title: 'Other Dev - Company',
      type: 'about',
      category: 'company',
      subtype: 'overview',
      year: '2025',
  ...
  {
    content:
      'Who founded Other Dev? Other Dev was founded in 2021 by two entrepreneurs: Kabeer Jaffri and Ossaid Qadri. They met at Habib Public School in Karachi and later established the agency to deliver premium web development and digital marketing services. Kabeer serves as Founder and Technical Lead, bringing 8+ years of full-stack development experience. Ossaid serves as Co-Founder, Frontend Architect, and Growth Lead, specializing in Next.js, React, and growth marketing campaigns. Both founders operate under a philosophy of zero unnecessary fluff — clean code and systems that work.',
    metadata: {
      source: 'about',
