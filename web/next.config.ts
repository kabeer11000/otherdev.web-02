    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-eval' 'unsafe-inline' cdn.jsdelivr.net unpkg.com esm.sh https://mcp.figma.com https://www.googletagmanager.com https://www.google-analytics.com",
              "style-src 'self' 'unsafe-inline' cdn.jsdelivr.net fonts.googleapis.com",
              "img-src 'self' data: blob: images.unsplash.com cdn.jsdelivr.net github.com localhost:3845 cdn.shadcnstudio.com media.otherdev.com *.r2.dev localhost:3000",
              "font-src 'self' fonts.gstatic.com",
              "connect-src 'self' api.groq.com api.mistral.ai *.googleapis.com *.firebaseio.com https://mcp.figma.com https://www.google-analytics.com https://analytics.google.com",
              "frame-src 'self'",
              "object-src 'none'",
              "base-uri 'self'",
            ].join('; '),
